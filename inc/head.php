...
if(isset($_GET['add_to_cart'])) {
    if($_COOKIE['card']) {
        $counter = count($_COOKIE['card']);
    } else {
        $counter = 0;
    }
    setcookie("card[" . $counter . "]", $_GET['add_to_cart']);
}
...
<body>
  ...
  <div class="container-fluid text-right">
    <strong><?php echo (!empty($_SESSION["userName"])) ? "Bienvenue " . $_SESSION["userName"] : "Entrez votre nom !";?></strong>
  </div>
</header>
